...
public class ScreenRecordManager {
    ...
    public static void startRecording() {
     // To Do: check if  flag for recording is enabled
            try {
                ...
                //To Do: check if the execution type is local

                {
                    // Configure the recorder
                    recorder.set(
                            RecorderFactory.getRecorder(
                                    VideoRecorder.conf().recorderType()
                            )
                    );
    ...
    /**
     * Stops screen recording and saves the video file.
     */
